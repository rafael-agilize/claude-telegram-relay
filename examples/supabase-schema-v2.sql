...
-- Get current soul version (latest version)
...
-- Save a new soul version with auto-incremented version number
...
-- Get recent soul version history (excludes reflection_notes)
...
-- Get milestone moments by recency
